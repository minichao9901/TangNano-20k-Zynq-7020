...
uint8_t OV5640_Check = 0,OV2640_Check = 0,NO_Camera = 0;
...
void Camera_check()
{
	...
	if(ID == OV5640_ID)  //获取到正确的ID：OV5640
		OV5640_Check = 1;
	else {
		OV5640_Check = 0;
		SCCB_Write_REG8(0xff,0x01);//选中DSP Address
		usleep(50000);
		//读OV2640摄像头ID
		ID=SCCB_Read_REG8(0x1c);	//读取厂家ID 高八位
		ID<<=8;
		ID|=SCCB_Read_REG8(0x1d);	//读取厂家ID 低八位
		if(ID == OV2640_ID)  //获取到正确的ID：OV2640
			OV2640_Check = 1;
		else
		{
			OV2640_Check = 0;
...
void Camera_Init()
{
    if(OV5640_Check)  //获取到正确的ID：OV5640
    {
    ...
    {
		if(OV2640_Check)  //获取到正确的ID：OV2640
    	   {
			SCCB_Write_REG8(0xff,0x01);
			SCCB_Write_REG8(0x12,0x80);
			usleep(50000);

			SCCB_Write_REG8(0xff,0x00);//选中DSP Address
			SCCB_Write_REG8(0x2c,0xff);
			SCCB_Write_REG8(0x2e,0xdf);
			SCCB_Write_REG8(0xff,0x01);
			SCCB_Write_REG8(0x3c,0x32);
			//
			SCCB_Write_REG8(0x11,0x00);
			SCCB_Write_REG8(0x09,0x02);
			SCCB_Write_REG8(0x04,0x20);//水平镜像,垂直不翻转
			SCCB_Write_REG8(0x13,0xe5);
			SCCB_Write_REG8(0x14,0x48);
			SCCB_Write_REG8(0x2c,0x0c);
			SCCB_Write_REG8(0x33,0x78);
			SCCB_Write_REG8(0x3a,0x33);
			SCCB_Write_REG8(0x3b,0xfB);
			//
			SCCB_Write_REG8(0x3e,0x00);
			SCCB_Write_REG8(0x43,0x11);
			SCCB_Write_REG8(0x16,0x10);
			//
			SCCB_Write_REG8(0x39,0x92);
			//
			SCCB_Write_REG8(0x35,0xda);
			SCCB_Write_REG8(0x22,0x1a);
			SCCB_Write_REG8(0x37,0xc3);
			SCCB_Write_REG8(0x23,0x00);
			SCCB_Write_REG8(0x34,0xc0);
			SCCB_Write_REG8(0x36,0x1a);
			SCCB_Write_REG8(0x06,0x88);
			SCCB_Write_REG8(0x07,0xc0);
			SCCB_Write_REG8(0x0d,0x87);
			SCCB_Write_REG8(0x0e,0x41);
			SCCB_Write_REG8(0x4c,0x00);
			SCCB_Write_REG8(0x48,0x00);
			SCCB_Write_REG8(0x5B,0x00);
			SCCB_Write_REG8(0x42,0x03);
			//
			SCCB_Write_REG8(0x4a,0x81);
			SCCB_Write_REG8(0x21,0x99);
			//
			SCCB_Write_REG8(0x24,0x40);
			SCCB_Write_REG8(0x25,0x38);
			SCCB_Write_REG8(0x26,0x82);
			SCCB_Write_REG8(0x5c,0x00);
			SCCB_Write_REG8(0x63,0x00);
			SCCB_Write_REG8(0x46,0x22);
			SCCB_Write_REG8(0x0c,0x3c);
			//
			SCCB_Write_REG8(0x61,0x70);
			SCCB_Write_REG8(0x62,0x80);
			SCCB_Write_REG8(0x7c,0x05);
			//
			SCCB_Write_REG8(0x20,0x80);
			SCCB_Write_REG8(0x28,0x30);
			SCCB_Write_REG8(0x6c,0x00);
			SCCB_Write_REG8(0x6d,0x80);
			SCCB_Write_REG8(0x6e,0x00);
			SCCB_Write_REG8(0x70,0x02);
			SCCB_Write_REG8(0x71,0x94);
			SCCB_Write_REG8(0x73,0xc1);
			SCCB_Write_REG8(0x3d,0x34);
			SCCB_Write_REG8(0x5a,0x57);
			//根据分辨率不同而设置
			SCCB_Write_REG8(0x12,0x40);//SVGA 800*600
			SCCB_Write_REG8(0x17,0x11);//传感器窗口设置
			SCCB_Write_REG8(0x18,0x43);//传感器窗口设置
			SCCB_Write_REG8(0x19,0x00);//传感器窗口设置
			SCCB_Write_REG8(0x1a,0x4b);//传感器窗口设置
			SCCB_Write_REG8(0x32,0x09);
			SCCB_Write_REG8(0x37,0xc0);
			//
			SCCB_Write_REG8(0x4f,0xca);
			SCCB_Write_REG8(0x50,0xa8);
			SCCB_Write_REG8(0x5a,0x23);
			SCCB_Write_REG8(0x6d,0x00);
			SCCB_Write_REG8(0x3d,0x38);
			//
			SCCB_Write_REG8(0xff,0x00);
			SCCB_Write_REG8(0xe5,0x7f);
			SCCB_Write_REG8(0xf9,0xc0);
			SCCB_Write_REG8(0x41,0x24);
			SCCB_Write_REG8(0xe0,0x14);
			SCCB_Write_REG8(0x76,0xff);
			SCCB_Write_REG8(0x33,0xa0);
			SCCB_Write_REG8(0x42,0x20);
			SCCB_Write_REG8(0x43,0x18);
			SCCB_Write_REG8(0x4c,0x00);
			SCCB_Write_REG8(0x87,0xd5);
			SCCB_Write_REG8(0x88,0x3f);
			SCCB_Write_REG8(0xd7,0x03);
			SCCB_Write_REG8(0xd9,0x10);
			SCCB_Write_REG8(0xd3,0x82);
			//
			SCCB_Write_REG8(0xc8,0x08);
			SCCB_Write_REG8(0xc9,0x80);
			//
			SCCB_Write_REG8(0x7c,0x00);
			SCCB_Write_REG8(0x7d,0x00);
			SCCB_Write_REG8(0x7c,0x03);
			SCCB_Write_REG8(0x7d,0x48);
			SCCB_Write_REG8(0x7d,0x48);
			SCCB_Write_REG8(0x7c,0x08);
			SCCB_Write_REG8(0x7d,0x20);
			SCCB_Write_REG8(0x7d,0x10);
			SCCB_Write_REG8(0x7d,0x0e);
			//
			SCCB_Write_REG8(0x90,0x00);
			SCCB_Write_REG8(0x91,0x0e);
			SCCB_Write_REG8(0x91,0x1a);
			SCCB_Write_REG8(0x91,0x31);
			SCCB_Write_REG8(0x91,0x5a);
			SCCB_Write_REG8(0x91,0x69);
			SCCB_Write_REG8(0x91,0x75);
			SCCB_Write_REG8(0x91,0x7e);
			SCCB_Write_REG8(0x91,0x88);
			SCCB_Write_REG8(0x91,0x8f);
			SCCB_Write_REG8(0x91,0x96);
			SCCB_Write_REG8(0x91,0xa3);
			SCCB_Write_REG8(0x91,0xaf);
			SCCB_Write_REG8(0x91,0xc4);
			SCCB_Write_REG8(0x91,0xd7);
			SCCB_Write_REG8(0x91,0xe8);
			SCCB_Write_REG8(0x91,0x20);
			//
			SCCB_Write_REG8(0x92,0x00);
			SCCB_Write_REG8(0x93,0x06);
			SCCB_Write_REG8(0x93,0xe3);
			SCCB_Write_REG8(0x93,0x05);
			SCCB_Write_REG8(0x93,0x05);
			SCCB_Write_REG8(0x93,0x00);
			SCCB_Write_REG8(0x93,0x04);
			SCCB_Write_REG8(0x93,0x00);
			SCCB_Write_REG8(0x93,0x00);
			SCCB_Write_REG8(0x93,0x00);
			SCCB_Write_REG8(0x93,0x00);
			...
			SCCB_Write_REG8(0x97,0x08);
			SCCB_Write_REG8(0x97,0x19);
			SCCB_Write_REG8(0x97,0x02);
			SCCB_Write_REG8(0x97,0x0c);
			SCCB_Write_REG8(0x97,0x24);
			SCCB_Write_REG8(0x97,0x30);
			SCCB_Write_REG8(0x97,0x28);
			SCCB_Write_REG8(0x97,0x26);
			SCCB_Write_REG8(0x97,0x02);
			SCCB_Write_REG8(0x97,0x98);
			SCCB_Write_REG8(0x97,0x80);
			SCCB_Write_REG8(0x97,0x00);
			SCCB_Write_REG8(0x97,0x00);
			//
			SCCB_Write_REG8(0xc3,0xed);
			SCCB_Write_REG8(0xa4,0x00);
			SCCB_Write_REG8(0xa8,0x00);
			SCCB_Write_REG8(0xc5,0x11);
			SCCB_Write_REG8(0xc6,0x51);
			SCCB_Write_REG8(0xbf,0x80);
			SCCB_Write_REG8(0xc7,0x10);
			SCCB_Write_REG8(0xb6,0x66);
			SCCB_Write_REG8(0xb8,0xA5);
			SCCB_Write_REG8(0xb7,0x64);
			SCCB_Write_REG8(0xb9,0x7C);
			SCCB_Write_REG8(0xb3,0xaf);
			SCCB_Write_REG8(0xb4,0x97);
			SCCB_Write_REG8(0xb5,0xFF);
			SCCB_Write_REG8(0xb0,0xC5);
			SCCB_Write_REG8(0xb1,0x94);
			SCCB_Write_REG8(0xb2,0x0f);
			SCCB_Write_REG8(0xc4,0x5c);
			//根据分辨率不同而设置
			SCCB_Write_REG8(0xc0,0x64);//图像尺寸设置 //800 = 100(0x64) * 8
			//SCCB_Write_REG8(= 0x,0x1_4B);//图像尺寸设置 //600 = 75(0x4B) * 8 //3C
			SCCB_Write_REG8(0xc1,0x4B);//图像尺寸设置 //600 = 75(0x4B) * 8 //3C
			SCCB_Write_REG8(0x8c,0x00);//图像尺寸设置
			SCCB_Write_REG8(0x86,0x3D);
			SCCB_Write_REG8(0x50,0x00);
			SCCB_Write_REG8(0x51,0xC8);//图像窗口设置
			SCCB_Write_REG8(0x52,0x96);//图像窗口设置
			SCCB_Write_REG8(0x53,0x00);//图像窗口设置
			SCCB_Write_REG8(0x54,0x00);//图像窗口设置
			SCCB_Write_REG8(0x55,0x00);//图像窗口设置
			SCCB_Write_REG8(0x5a,0xC8);
			SCCB_Write_REG8(0x5b,0x96);
			SCCB_Write_REG8(0x5c,0x00);
		   //
			SCCB_Write_REG8(0xd3,0x82);//auto设置要小心   82
			//
			SCCB_Write_REG8(0xc3,0xed);
			SCCB_Write_REG8(0x7f,0x00);
//    		SCCB_Write_REG8(0xda,0x09);//08
			SCCB_Write_REG8(0xda,0x08);//08

			SCCB_Write_REG8(0xc2,0x0e);
			SCCB_Write_REG8(0xe5,0x1f);
			SCCB_Write_REG8(0xe1,0x67);
			SCCB_Write_REG8(0xe0,0x00);
			SCCB_Write_REG8(0xdd,0x7f);
			SCCB_Write_REG8(0x05,0x00);

			SCCB_Write_REG8(0xFF, 0x00);
			SCCB_Write_REG8(0xD7, 0x03);
			SCCB_Write_REG8(0xDF, 0x02);
			SCCB_Write_REG8(0x33, 0xa0);
			SCCB_Write_REG8(0x3C, 0x00);
			SCCB_Write_REG8(0xe1, 0x67);
		}
    }
}
